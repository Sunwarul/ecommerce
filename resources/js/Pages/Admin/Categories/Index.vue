            ...
            <template #form="{
                ...
                <div class="flex flex-col gap-6">
                    <div>
                        ...
                        <Select v-model="form.parent_id" :options="categories" option-label="name" option-value="id"
                            placeholder="Select a Category" class="w-full" />
                        <small v-if="submitted && !form.parent_id" class="text-red-500">Category is required.</small>
                    </div>
                </div>
                <div class="flex flex-col gap-6">
                    <div>
