import{s as d}from"./index-C7WJurIO.js";import{B as c,c as a,o,d as i,m as r,K as l,J as v,M as u,b as y,t as b}from"./app-CsVeLNYl.js";var f=function(e){var n=e.dt;return`
...
`)},D={root:function(e){var n=e.props;return["p-tag p-component",{"p-tag-info":n.severity==="info","p-tag-success":n.severity==="success","p-tag-warn":n.severity==="warn","p-tag-danger":n.severity==="danger","p-tag-secondary":n.severity==="secondary","p-tag-contrast":n.severity==="contrast","p-tag-rounded":n.rounded}]},icon:"p-tag-icon",label:"p-tag-label"},T=c.extend({name:"tag",theme:B,classes:D}),j={name:"BaseTag",extends:d,props:{value:null,severity:null,rounded:Boolean,icon:String},style:T,provide:function(){return{$pcTag:this,$parentInstance:this}}},x={name:"Tag",extends:j,inheritAttrs:!1};function C(t,e,n,s,p,g){return o(),a("span",r({class:t.cx("root")},t.ptmi("root")),[t.$slots.icon?(o(),v(u(t.$slots.icon),r({key:0,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(o(),a("span",r({key:1,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):i("",!0),t.value!=null||t.$slots.default?l(t.$slots,"default",{key:2},function(){return[y("span",r({class:t.cx("label")},t.ptm("label")),b(t.value),17)]}):i("",!0)],16)}x.render=C;export{x as a,z as s};
